...
private:
    ...
    static constexpr uint32_t MASKING_HOLDOFF   = 200;   // ms
    static constexpr float    ALPHA             = 0.6f;  // EMA factor for period
    static constexpr float    MIN_THRESHOLD     = 20.0f;
    static constexpr float    MAX_THRESHOLD     = 800.0f;
    static constexpr float    STEP_RESILIENCY   = 30.0f; // max negative jump
